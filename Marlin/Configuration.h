...
/* 
Firmware für Prusa i3 Drucker mit Zrib 1.1 by teklab.de
*/
...
#define EPR_MAGIC_ID			38

// Define this to set a custom name for your generic Mendel,
#define CUSTOM_MENDEL_NAME  	"TekBot v6"
#define	MACHINE_FW_VERSION		"TekBot_v1_3.4"
...
#define LCD_FEEDBACK_FREQUENCY_HZ 		   2000	// this is the tone frequency the buzzer plays when on UI feedback. ie Screen Click
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 200 // the duration the buzzer plays the UI feedback sound. ie Screen Click
